...
('john_reader', 'john@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'John Reader'),
('jane_bookworm', 'jane@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Jane Bookworm');

-- Insert sample books
INSERT INTO books (title, author, description, price, preview_chapters, total_chapters) VALUES
('The Great Adventure', 'John Smith', 'An exciting tale of adventure and discovery in unknown lands. Follow our hero as he embarks on a journey that will change his life forever. This thrilling story combines action, mystery, and personal growth in an unforgettable narrative.', 9.99, 2, 15),
('Mystery of the Lost City', 'Jane Doe', 'A thrilling mystery novel about an ancient city lost in time. Archaeologists discover secrets that were meant to stay buried. Join Dr. Sarah Chen as she uncovers the truth behind one of history''s greatest mysteries.', 12.99, 3, 20),
('Digital Future', 'Tech Writer', 'Explore the possibilities of our digital future and how technology will shape our lives in the coming decades. From AI to quantum computing, discover what lies ahead for humanity in the digital age.', 15.99, 2, 12),
('Love in Paris', 'Romance Author', 'A beautiful love story set in the romantic city of Paris. Follow Emma as she discovers love, life, and herself in the city of lights. A heartwarming tale of second chances and new beginnings.', 8.99, 2, 18),
('Cooking Mastery', 'Chef Master', 'Master the art of cooking with this comprehensive guide. From basic techniques to advanced recipes, become the chef you''ve always wanted to be. Includes over 200 recipes and professional tips.', 19.99, 3, 25);
...
INSERT INTO purchases (user_id, book_id, payment_method, transaction_id, amount, status) VALUES
(2, 1, 'mpesa', 'TXN_1234567890', 9.99, 'completed'),
(3, 2, 'paypal', 'TXN_0987654321', 12.99, 'completed');

-- Insert sample reviews
INSERT INTO book_reviews (user_id, book_id, rating, review_text) VALUES
(2, 1, 5, 'Amazing adventure story! Could not put it down. The characters are well-developed and the plot keeps you on the edge of your seat.'),
(3, 2, 4, 'Great mystery novel with excellent world-building. The archaeological details are fascinating and add authenticity to the story.');